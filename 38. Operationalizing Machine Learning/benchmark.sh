...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer fLIx547OhxRksUApsd08lVGCM9hHgIUG' http://1ff7396c-24f9-4746-9656-5aacb3ec33b2.eastus.azurecontainer.io/score
