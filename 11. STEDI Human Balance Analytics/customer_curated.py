...
drop_fields_node174355679384 = DropFields.apply(
    frame=join_customer_node174355678923,
    paths=["timeStamp", "user", "x", "y", "z"],
    transformation_ctx="drop_fields_node174355679384",
)

# Script generated for node Customer Curated
customer_curated_node174355679385 = glueContext.write_dynamic_frame.from_catalog(
    frame=drop_fields_node174355679384,
    database="workspace",
    table_name="customer_curated",
    transformation_ctx="customer_curated_node174355679385",
)
